...
export default function Level1Olfactory({
  onStressChange,
  onWin,
  onLose,
}: Props) {
  ...
  const [_vialX, setVialX] = useState(0);
  ...
  const [instructions, setInstructions] = useState(
    "Hold Q+W+E+R together to grip the vial",
  );
  ...
  useEffect(() => {
    const down = (e: KeyboardEvent) => {
      ...
      if (e.key === "q" || e.key === "Q")
        setFingers((f) => ({ ...f, q: true }));
      if (e.key === "w" || e.key === "W")
        setFingers((f) => ({ ...f, w: true }));
      if (e.key === "e" || e.key === "E")
        setFingers((f) => ({ ...f, e: true }));
      if (e.key === "r" || e.key === "R")
        setFingers((f) => ({ ...f, r: true }));
      if (
        (e.key === "a" || e.key === "A") &&
        grippingRef.current &&
        phase === "move"
    ...
    const up = (e: KeyboardEvent) => {
      if (e.key === "q" || e.key === "Q")
        setFingers((f) => ({ ...f, q: false }));
      if (e.key === "w" || e.key === "W")
        setFingers((f) => ({ ...f, w: false }));
      if (e.key === "e" || e.key === "E")
        setFingers((f) => ({ ...f, e: false }));
      if (e.key === "r" || e.key === "R")
        setFingers((f) => ({ ...f, r: false }));
    };
    ...
    >
      ...
      <div className="relative w-full max-w-3xl" style={{ height: 380 }}>
        ...
        >
          ...
          <div
            ...
            style={{
              width: 70,
              height: 80,
              background: "hsl(35,60%,65%)",
              border: "2px solid hsl(35,50%,50%)",
          ...
          <div
            style={{
              width: 24,
              height: 20,
              background: "hsl(35,55%,60%)",
              borderLeft: "2px solid hsl(35,45%,50%)",
              borderRight: "2px solid hsl(35,45%,50%)",
            }}
          />
          {/* Body */}
          <div
            style={{
              ...
              border: "2px solid hsl(200,25%,60%)",
              borderRadius: 4,
            }}
          />
          {/* Label */}
          <div className="mt-2 text-xs text-muted-foreground/50 tracking-widest">
            PATIENT
          </div>
        </div>
          ...
          {!gripping && (
            <div
              ...
              style={{
                ...
                height: 50,
                background:
                  "linear-gradient(180deg, rgba(180,240,255,0.6) 0%, rgba(100,200,240,0.4) 100%)",
        ...
        >
          ...
          <div
            style={{
              width: 30,
              height: 120,
              background: "hsl(220,30%,45%)",
              border: "2px solid hsl(220,25%,55%)",
              borderRadius: 4,
              position: "relative",
            }}
          >
              ...
              {[
                ...
                <div key={key} className="flex flex-col items-center gap-0.5">
                  ...
                  <span
                    style={{
                      fontSize: 8,
                      color: state ? "hsl(180,60%,60%)" : "hsl(0,0%,40%)",
                    }}
                  >
                    {key}
                  </span>
          ...
          {gripping && (
            <div
              style={{
                ...
                marginBottom: 4,
                background:
                  "linear-gradient(180deg, rgba(180,240,255,0.7) 0%, rgba(100,200,240,0.5) 100%)",
        ...
        {dropped && (
          <div
            className="absolute"
            style={{ left: vialPx, bottom: 60, animation: "fall 0.5s ease-in" }}
          >
            <div
              style={{
                width: 12,
                height: 40,
                background:
                  "linear-gradient(180deg, rgba(180,240,255,0.4) 0%, rgba(100,200,240,0.2) 100%)",
      ...
      <div className="absolute bottom-16 left-1/2 -translate-x-1/2 flex gap-3">
        {[
          ...
          <div key={key} className="flex flex-col items-center gap-1">
            <div
              className="text-xs"
              style={{ color: active ? "hsl(180,60%,55%)" : "hsl(0,0%,30%)" }}
            >
              {active ? "●" : "○"}
            </div>
            <div
              style={{
                width: 36,
                height: 36,
                border: `2px solid ${active ? "hsl(180,60%,55%)" : "hsl(0,0%,25%)"}`,
                display: "flex",
                alignItems: "center",
        ...
        <div
          style={{ width: 1, background: "hsl(0,0%,20%)", margin: "0 8px" }}
        />
        {[
          { key: "A", label: "←" },
          { key: "D", label: "→" },
          ...
          <div
            ...
            style={{
              width: 36,
              height: 36,
              border: `2px solid ${gripping ? "hsl(180,40%,40%)" : "hsl(0,0%,18%)"}`,
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
      ...
      {showDialogue && (
        <div
          className="absolute top-32 right-24 z-30 max-w-xs"
          style={{
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              borderRight: "8px solid hsl(210,15%,25%)",
            }}
          />
        </div>
      )}
