...
const MUSCLE_GROUPS: MuscleGroup[] = [
  ...
  },
  {
    id: 7,
    key: "7",
    label: "Orbicularis Ori",
    description: "Lip purse",
    cx: 185,
    cy: 265,
    rx: 38,
    ry: 20,
...
const EXPRESSIONS: Expression[] = [
  {
    name: "SMILE",
    description: "Raise cheeks, relax forehead",
    requiredMuscles: [6],
    forbiddenMuscles: [2, 3, 7],
  },
  {
    name: "FROWN",
    description: "Furrow brows, purse lips",
    requiredMuscles: [2, 3, 7],
    forbiddenMuscles: [6],
  },
  {
    name: "SURPRISE",
    description: "Raise forehead and brows wide",
    requiredMuscles: [1, 4, 5],
    forbiddenMuscles: [6, 7],
  },
  {
    name: "WINCE",
    description: "Squeeze eyes, tighten chin",
    requiredMuscles: [4, 5, 8],
    forbiddenMuscles: [1],
  },
];
    ...
    >
      ...
      <div className="absolute top-20 left-1/2 -translate-x-1/2 text-center z-20">
        ...
        <div
          ...
          style={{ textShadow: "0 0 20px hsl(180,60%,40%)" }}
        >
          {expression.name}
        </div>
      ...
      <div className="absolute top-20 right-8 z-20 text-right">
        <div className="text-xs text-muted-foreground/50 tracking-widest uppercase mb-1">
          Expression {completed + 1} / {EXPRESSIONS.length}
        </div>
        <div
          className={`text-2xl font-bold ${timeLeft <= 4 ? "text-destructive" : "text-foreground"}`}
        >
          {timeLeft}s
        </div>
      </div>
      ...
      <div className="absolute top-20 left-8 z-20">
        ...
        <div
          ...
          style={{
            color: matchScore >= 80 ? "hsl(180,60%,55%)" : "hsl(45,90%,55%)",
          }}
        >
          {matchScore}%
        </div>
      ...
      <div className="flex items-center gap-12">
        ...
        <div
          ...
          style={{
            filter: flashMatch
              ? "drop-shadow(0 0 20px hsl(180,60%,50%))"
              : "none",
        ...
        >
          <svg viewBox="0 0 370 380" width="320" height="330">
              ...
              return (
                <g key={mg.id}>
                  ...
                  <text
                    ...
                    textAnchor="middle"
                    fill={
                      isActive ? "hsl(180,70%,70%)" : "rgba(255,255,255,0.3)"
                    }
                    fontSize="10"
            ...
            {/* Eyebrows */}
            <path
              d={`M 125 ${active.has(1) ? 147 : 152} Q 155 ${active.has(1) ? 140 : 145} 175 ${active.has(1) ? 147 : 152}`}
              fill="none"
              stroke="hsl(25,40%,28%)"
              strokeWidth="4"
              strokeLinecap="round"
            ...
            />
            <path
              d={`M 195 ${active.has(1) ? 147 : 152} Q 215 ${active.has(1) ? 140 : 145} 245 ${active.has(1) ? 147 : 152}`}
              fill="none"
              stroke="hsl(25,40%,28%)"
              strokeWidth="4"
              strokeLinecap="round"
            ...
            {/* Nose */}
            <path
              d="M 178 185 Q 185 210 177 222 Q 185 226 193 222 Q 185 210 192 185"
              fill="hsl(35,40%,55%)"
            />
            {/* Mouth */}
            <path
        ...
        <div className="flex flex-col gap-2">
          <div className="text-xs text-muted-foreground/50 tracking-widest uppercase mb-2 text-center">
            Muscle Keys
          </div>
                ...
                <div key={mg.id} className="flex items-center gap-2">
                  <div
                    style={{
                      width: 32,
                      height: 32,
                      border: `2px solid ${isActive ? "hsl(180,60%,55%)" : isRequired ? "hsl(180,40%,30%)" : isForbidden ? "hsl(0,50%,35%)" : "hsl(0,0%,22%)"}`,
                      display: "flex",
                      alignItems: "center",
                  ...
                  <div>
                    <div
                      className={`text-xs font-bold ${isActive ? "text-primary" : "text-muted-foreground/50"}`}
                    >
                      {mg.label}
                    </div>
                    <div
          ...
          <div className="mt-4 flex flex-col gap-1">
            <div className="text-xs text-muted-foreground/40 tracking-widest uppercase mb-1">
              Legend
            </div>
