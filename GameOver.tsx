    ...
    <div className="w-screen h-screen flex flex-col items-center justify-center bg-background relative">
      ...
      <div className="absolute top-1/3 left-0 right-0 h-16 opacity-20 pointer-events-none">
        <svg viewBox="0 0 1000 60" className="w-full h-full" preserveAspectRatio="none">
          <line x1="0" y1="30" x2="300" y2="30" stroke="hsl(0,70%,50%)" strokeWidth="2"/>
          <polyline points="300,30 320,30 330,5 340,55 350,30 370,30" fill="none" stroke="hsl(0,70%,50%)" strokeWidth="2"/>
          <line x1="370" y1="30" x2="1000" y2="30" stroke="hsl(0,70%,50%)" strokeWidth="2"/>
        </svg>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 max-w-lg text-center px-8">
        ...
        <div className="text-xs text-muted-foreground/40 tracking-wider">
          The patient has requested a different doctor.<br/>
